...
export const I18n = {
  ...
  translations: {
    it: {
      ...
      // Translation
      "translation.empty":
        "Clicca sul pulsante per tradurre l'articolo completo",
      "translation.button": "🌍 Traduci Articolo",

      // Citations
      "citations.empty":
        "📚 Estrai citazioni e riferimenti bibliografici dall'articolo",
      ...
      "error.tooShort":
        "Articolo troppo breve per essere riassunto (minimo 200 parole).",
      "error.noApiKey":
        "API key non configurata. Clicca sull'icona ⚙️ per configurare.",
      "error.invalidKey":
        "API key non valida. Verifica la configurazione nelle impostazioni.",
      ...
      // ========== NUOVE CHIAVI - TRANSLATION ==========

      "translation.loading":
        "Traduzione in corso... Questo potrebbe richiedere 10-30 secondi.",
      "translation.errorMessage": "❌ Errore durante la traduzione:",
      "translation.clickToTranslate":
        "Clicca sul pulsante per tradurre l'articolo completo",
      ...
      "history.favoritesNotDeleted":
        "⭐ {count} articoli preferiti NON verranno eliminati.",
      "history.favoritesNotDeletedMulti":
        "⭐ {count} analisi preferite NON verranno eliminate.",
      ...
      "settings.apiKeys.desc":
        "Le tue chiavi sono salvate localmente nel tuo browser.",
      "settings.test": "🧪 Test",
      ...
      "settings.perf.cacheDesc":
        "Salva i riassunti in cache per evitare chiamate API duplicate",
      "settings.perf.cacheTTL": "Durata Cache (giorni)",
      "settings.perf.enableFallback":
        "Abilita Fallback Automatico tra Provider",
    ...
    en: {
      ...
      // Citations
      "citations.empty":
        "📚 Extract citations and bibliographic references from the article",
      ...
      // Errors
      "error.noArticle":
        "No article detected on this page. Try with a blog or news article.",
      "error.tooShort": "Article too short to summarize (minimum 200 words).",
      "error.noApiKey":
        "API key not configured. Click the ⚙️ icon to configure.",
      ...
      "history.confirmClearSingle":
        "Are you sure you want to clear all single article history?",
      "history.confirmClearMulti":
        "Are you sure you want to clear all multi-article analysis history?",
      "history.favoritesNotDeleted":
        "⭐ {count} favorite articles will NOT be deleted.",
      "history.favoritesNotDeletedMulti":
        "⭐ {count} favorite analyses will NOT be deleted.",
      ...
      "settings.perf.cacheDesc":
        "Save summaries in cache to avoid duplicate API calls",
      ...
      "settings.perf.compressionDesc":
        "Automatically compress old history and cache to save space",
      "settings.perf.autoCleanup": "Automatic Cleanup",
      "settings.perf.cleanupDesc":
        "Automatically clean expired cache and very old history",
