...
2. Clona il tuo fork localmente:
   ```bash
   git clone https://github.com/TUO_USERNAME/web-article-summarizer.git
...
Controlla la pagina [Issues](https://github.com/AndreaBonn/web-article-summarizer/issues) per bug segnalati.
